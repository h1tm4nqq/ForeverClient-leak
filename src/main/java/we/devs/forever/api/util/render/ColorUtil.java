...
class ColorUtil {
    ...
    public static int getColorAlpha(Color color, int a) {
        return toRGBA(color.getRed(), color.getGreen(), color.getBlue(), a);
    }

    public static int getColorAlpha(Color color, float a) {
        return toRGBA(color.getRed(), color.getGreen(), color.getBlue(), a);
    }
    ...
    public static Color changeAlpha(Color origColor, int userInputedAlpha) {
        return new Color(origColor.getRed(),origColor.getGreen(),origColor.getBlue(),userInputedAlpha); //add the one the user inputted
    }
