...
public class OctagrasmsShader extends FramebufferShader {
    public static final OctagrasmsShader INSTANCE;

    static {
        INSTANCE = new OctagrasmsShader();
    }

    public float time;

    public OctagrasmsShader() {
        super("Octagrams.frag");
