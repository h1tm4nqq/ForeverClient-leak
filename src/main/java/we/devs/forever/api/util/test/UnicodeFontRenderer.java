...
//
//    public UnicodeFontRenderer(String fontName, int fontStyle, float fontSize, float kerning, float antiAliasingFactor) {
...
//        return getFontFromInput("/assets/forever/fonts/" + name + ".ttf");
//    }
//
//    private Font getFontFromInput(String path) throws IOException, FontFormatException {
//        return Font.createFont(fontStyle, Objects.requireNonNull(Client.class.getResourceAsStream(path)));
//    }
//
...
//
//                case '\n':
//                    y += getHeight(Character.toString(charr)) * 2.0F;
//                    break;
//
//                case ' ':
...
//                        colorIndex = 15;
//                    }
//                    currentColor = this.colorCodes[colorIndex];
//                    if(colorIndex == 21) currentColor = color;
//                    x -= (getWidth(temp) * 2.0F * antiAliasingFactor);
//                    index++;
//                    continue;
//            }
//
//            unicodeFont.drawString(x, y, temp, new org.newdawn.slick.Color(currentColor));
//            index++;
//            x += (getWidth(temp) * 2.0F * antiAliasingFactor);
//        }
//
...
//        if (shadow) drawString(StringUtils.stripControlCodes(text), x + 0.5F, y + 0.5F, 0x000000);
//        return drawString(text, x, y, color);
//    }
//
