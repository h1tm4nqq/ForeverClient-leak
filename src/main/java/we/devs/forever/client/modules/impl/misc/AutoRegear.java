...
public class AutoRegear extends Module {
    ...
    public Setting<Integer> tickDelay = (new Setting<>("TickDelay", 0, 0, 20));
    public Setting<Integer> switchForTick = (new Setting<>("SwitchForTick", 1, 1, 20));
    public Setting<Boolean> enderChest = (new Setting<>("EnderChest", false));
    public Setting<Boolean> confirmSort = (new Setting<>("ConfirmSort", true));
    public Setting<Boolean> invasive = (new Setting<>("Invasive", false));
    ...
    public AutoRegear() {
        super("AutoRegear", "Automatically regear", Category.MISC);
    }
    @Override
