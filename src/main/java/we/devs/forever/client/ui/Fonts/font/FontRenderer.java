package we.devs.forever.client.ui.Fonts.font;
...
public class FontRenderer {
    ...
    public FontRenderer(Font font, boolean antiAlias) {
        ...
        fontImage = new FontImage(new Font(font.getFontName(),font.getStyle(),font.getSize() + 19));
    }
    ...
    public int drawString(String text, float x, float y, int color, boolean shadow) {
        ...
        if (text.contains("\n")) {
            ...
            for (String word : words) {
                drawText(word, x, scaledY + nextLineY, color, shadow);
                nextLineY += getHeight();
            }
        ...
        if (shadow) {
            drawText(text, x + 0.4F, scaledY + 0.3F, new Color(0, 0, 0, 150).getRGB(), true);
        }

        // draw given text
        return drawText(text, x, scaledY, color, false);
    }
     ...
     * @return The integer value of the render
     */
    private int drawText(String in, float x, float y, int color, boolean ignoreColor) {
